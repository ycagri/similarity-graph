...
- `skip_graph`: This option is defined to skip Graph Commons graph generation.
...
- `python3 main.py --name battle --description "A similarity graph for historical battles" --skip_prompt`
